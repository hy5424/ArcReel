...
export default {
  ...
  'prompt_profile_standard_desc': 'Output structured fields (action/camera/audio/dialogue) for general video backends.',
  'prompt_profile_seedance': 'Smart Director',
  'prompt_profile_seedance_desc': 'Output full Jimeng Seedance 2.0 smart-director format prompts (positioning, time blocks, forbidden tags) for better visual quality.',
