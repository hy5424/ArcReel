...
export default {
  ...
  'prompt_profile_seedance': 'Seedance Director',
  'prompt_profile_seedance_desc': 'Output full Jimeng Seedance 2.0 director-format prompts (positioning, time blocks, forbidden tags) for better visual quality.',
