...
export default {
  ...
  'prompt_profile_seedance': 'Đạo diễn Seedance',
  'prompt_profile_seedance_desc': 'Xuất prompt định dạng đạo diễn Jimeng Seedance 2.0 đầy đủ (vị trí, khối thời gian, thẻ cấm) để có chất lượng hình ảnh tốt hơn.',
