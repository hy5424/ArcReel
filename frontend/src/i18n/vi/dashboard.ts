...
export default {
  ...
  'prompt_profile_label': 'Hồ sơ Prompt',
  'prompt_profile_standard': 'Tiêu chuẩn',
  'prompt_profile_standard_desc': 'Xuất các trường có cấu trúc (hành động/máy quay/âm thanh/đối thoại) cho các backend video chung.',
  'prompt_profile_seedance': 'Đạo diễn thông minh',
  'prompt_profile_seedance_desc': 'Xuất prompt định dạng đạo diễn thông minh Jimeng Seedance 2.0 đầy đủ (vị trí, khối thời gian, thẻ cấm) để có chất lượng hình ảnh tốt hơn.',
