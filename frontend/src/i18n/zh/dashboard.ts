...
export default {
  ...
  'prompt_profile_label': '提示词模式',
  'prompt_profile_standard': '标准模式',
  'prompt_profile_standard_desc': '输出结构化字段（动作/运镜/环境音/对话），适合通用视频后端。',
  'prompt_profile_seedance': '智能导演',
  'prompt_profile_seedance_desc': '输出完整即梦 Seedance 2.0 智能导演格式提示词（含站位/分段时间块/禁止标签），画面质量更优。',
