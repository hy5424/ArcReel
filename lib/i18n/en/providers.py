...
MESSAGES: dict[str, str] = {
    ...
    "provider_name_dreamina": "Dreamina",
    ...
    "provider_desc_dreamina": "Jimeng Dreamina platform using CLI OAuth login for Seedance 2.0 video and image generation. No API key required.",
